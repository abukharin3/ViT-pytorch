...
def train(args, model):
    ...
    acc_file_name = "logs/{}_{}_{}_{}_{}_{}_{}_{}_{}_{}acc.npy".format(args.name, args.final_threshold, args.pruner_name, args.initial_warmup, args.final_warmup, args.beta3,
                                                                        args.local_window, args.deltaT, args.ma_uncertainty, args.ma_beta)
    np.save(acc_file_name, accs)

    params_file_name = "logs/{}_{}_{}_{}_{}_{}_{}_{}_{}_{}params.npy".format(args.name, args.final_threshold, args.pruner_name, args.initial_warmup, args.final_warmup, args.beta3,
                                                                        args.local_window, args.deltaT, args.ma_uncertainty, args.ma_beta)
